...
```{r fig-boxplot-norm-counternorm, fig.cap="Adherence to norms and counternorms by what scientists should do vs. actually do"}
survey_02_norms_long |>
  ggplot() +
  aes(norm_counternorm, rating, color = type) +
  geom_boxplot() +
