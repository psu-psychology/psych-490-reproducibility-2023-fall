...
- Project proposal
    - Every student or team must submit a one-page project proposal. If the proposal is submitted on-time ([by Friday, October 13]{.orange_due}), the student or team gets 5 extra credit points. If the proposal is submitted late, there is no penalty, but also no extra points. If a student or team does not submit a proposal, there will be a five point penalty.
- Project presentation (optional, but strongly recommended)
    ...
    - The presentations will occur during class on December 1, 4, and 6.
...
- Project write-up
    - Every student or team must submit a write-up, [due on Wednesday, December 13, 2023]{.orange_due}.
