...
::: {.callout-note}
In Fall 2024, I discovered that I had made some errors in assigning weights to the variables.
So, in correcting them, I wrote a function that should make the process more robust and transparent.
