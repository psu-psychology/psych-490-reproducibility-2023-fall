...
```{r fig-survey-01-timeseries, fig.cap="Time series of responses to Survey 01"}
survey_01_clean |>
...
```{r fig-scatterpairs-openness-q2-6, message=FALSE, fig.cap="Reponses to Openness to Revising One’s Viewpoint subscale questions from [@Krumrei-Mancuso2016-qm]"}
survey_01_clean[,2:6] |>
  ggpairs()
...
```{r fig-scatterpairs-trust-q7-11, message=FALSE, fig.cap="Responses to trust in science questions from [@Nadelson2014-ym]"}
...
```{r fig-scatterpairs-trust-q12-16, message=FALSE, fig.cap="Responses to trust in science questions from [@Nadelson2014-ym]"}
survey_01_clean[, 12:16] |>
  ggpairs()

survey_01_data_dictionary[12:16,1:2] |>
  knitr::kable(format = "html") |>
  kableExtra::kable_classic()
```

```{r fig-scatterpairs-trust-q17-21, message=FALSE, fig.cap="Responses to trust in science questions from [@Nadelson2014-ym]"}
q_range <- c(17:21)
